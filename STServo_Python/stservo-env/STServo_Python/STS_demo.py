...
while 1:
    ...
    for servo_id in range(1,NUM_SERVOS+1):
        ...
        sts_comm_result, sts_error = packetHandler.WritePosEx(servo_id, sts_goal_position[index], STS_MOVING_SPEED, STS_MOVING_ACC)
        ...
        while 1:
            ...
            moving, sts_comm_result, sts_error = packetHandler.ReadMoving(servo_id)
            if sts_comm_result != COMM_SUCCESS:
                print(packetHandler.getTxRxResult(sts_comm_result))
