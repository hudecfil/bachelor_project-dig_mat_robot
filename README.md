...
The driver board is powered by 200W with 10A maximum current supply. I set it to 8.47V (following the max. input voltage of SC servos - 8.4A). The step-down is
